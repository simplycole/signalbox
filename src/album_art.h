...
typedef struct { int status; char provider[32],sourceUrl[SB_ART_URL_MAX],mimeType[32],cachedPath[SB_ART_PATH_MAX],releaseId[SB_ART_ID_MAX]; unsigned int width,height; int64_t fetched; } SbAlbumArtResult;
